...
(function () {
  ...
  eq('the seven states are the seven states', MODEL.STATUSES.join(','),
    'draft,ready,ready_too_late,published,updated,manual_review,archived');
...
(function () {
  ...
  has(S, "check (status in ('draft', 'ready', 'ready_too_late', 'published', 'updated', 'manual_review', 'archived'))", 'the seven states are constrained');
