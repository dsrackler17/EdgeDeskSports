...
(function (root, factory) {
  ...
  function matchKey(tour, tourneyId, matchNum, sourceKey) {
    var src = sourceKey || 'archive';
    return src + ':' + String(tour).toUpperCase() + ':' + String(tourneyId) + ':' + String(matchNum);
  }
  ...
  function parseArchiveRow(r, opts) {
    ...
    var mId = matchKey(tour, tourneyId, matchNum, sourceKey);
