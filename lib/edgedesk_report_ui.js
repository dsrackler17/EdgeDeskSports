...
(function (root) {
  ...
  + '.edrp{width:100%;max-width:460px;margin:auto;background:#191510;color:#f1ebdf;border:1px solid #332a1b;'
  ...
  +   'font-family:inherit;text-align:left;color:#f1ebdf}'
  + '.edrp .edrp-ld{margin:0 0 14px;font-size:12.5px;color:#a29581}'
  + '.edrp .edrp-x{position:absolute;top:12px;right:12px;width:32px;height:32px;line-height:1;'
  +   'background:none;border:1px solid #332a1b;border-radius:9px;color:#a29581;font-size:17px;cursor:pointer}'
  + '.edrp label{display:block;font:700 10px/1.4 ui-monospace,SFMono-Regular,Menlo,monospace;'
  +   'letter-spacing:.07em!important;text-transform:uppercase!important;color:#887e70;margin:12px 0 5px}'
  + '.edrp input,.edrp select,.edrp textarea{width:100%;box-sizing:border-box;background:#221c15;'
  +   'border:1px solid #332a1b;color:#f1ebdf;border-radius:9px;padding:11px 12px;font:400 15px/1.45 inherit}'
  + '.edrp textarea{resize:vertical;min-height:96px}'
  + '.edrp input:focus,.edrp select:focus,.edrp textarea:focus{outline:2px solid #2fa79a;outline-offset:-1px}'
  ...
  +   'border:1px solid #2fa79a;background:#2fa79a;color:#042320;padding:0 14px}'
  + '.edrp-btn.ghost{background:none;color:#a29581;border-color:#332a1b}'
  ...
  + '.edrp-msg.ok{color:#76bd3e;background:rgba(118,189,62,.09);border:1px solid rgba(118,189,62,.3)}'
  ...
  + '.edrp-meta{margin-top:14px;border-top:1px solid #332a1b;padding-top:10px}'
  + '.edrp-meta summary{font-size:11.5px;color:#887e70;cursor:pointer}'
  + '.edrp-meta dl{margin:8px 0 0;font:400 11px/1.6 ui-monospace,SFMono-Regular,Menlo,monospace;color:#a29581;'
  +   'display:grid;grid-template-columns:auto 1fr;gap:2px 10px;word-break:break-word}'
  + '.edrp-meta dt{color:#6f6553}.edrp-meta dd{margin:0}'
  + '.edrp-foot{margin-top:12px;font-size:11px;color:#6f6553;line-height:1.55}'
  + '.edrp-launch{position:fixed;right:14px;bottom:calc(14px + env(safe-area-inset-bottom));z-index:2147482000;'
  +   'background:#191510;color:#a29581;border:1px solid #332a1b;border-radius:999px;padding:9px 14px;'
  +   'font:600 12px/1 Inter,system-ui,sans-serif;cursor:pointer;box-shadow:0 6px 18px rgba(0,0,0,.35)}'
  + '.edrp-launch:hover{color:#f1ebdf;border-color:#2fa79a}'
  ...
  function build() {
    ...
    back.innerHTML =
      ...
      + '<label for="edrpSteps">Anything that would help us reproduce it <span style="text-transform:none;letter-spacing:0;color:#6f6553">(optional)</span></label>'
      + '<textarea id="edrpSteps" rows="2" placeholder="Optional."></textarea>'
      + '<div id="edrpContactWrap" hidden><label for="edrpContact">Your email, if you would like a reply <span style="text-transform:none;letter-spacing:0;color:#6f6553">(optional)</span></label>'
