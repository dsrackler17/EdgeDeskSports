...
(function (root) {
  ...
  + '.edrp{width:100%;max-width:460px;margin:auto;background:#13161c;color:#e7eaf0;border:1px solid #262c36;'
  ...
  +   'font-family:inherit;text-align:left;color:#e7eaf0}'
  + '.edrp .edrp-ld{margin:0 0 14px;font-size:12.5px;color:#8a93a2}'
  + '.edrp .edrp-x{position:absolute;top:12px;right:12px;width:32px;height:32px;line-height:1;'
  +   'background:none;border:1px solid #262c36;border-radius:9px;color:#8a93a2;font-size:17px;cursor:pointer}'
  + '.edrp label{display:block;font:700 10px/1.4 ui-monospace,SFMono-Regular,Menlo,monospace;'
  +   'letter-spacing:.07em!important;text-transform:uppercase!important;color:#78818f;margin:12px 0 5px}'
  + '.edrp input,.edrp select,.edrp textarea{width:100%;box-sizing:border-box;background:#191d25;'
  +   'border:1px solid #262c36;color:#e7eaf0;border-radius:9px;padding:11px 12px;font:400 15px/1.45 inherit}'
  + '.edrp textarea{resize:vertical;min-height:96px}'
  + '.edrp input:focus,.edrp select:focus,.edrp textarea:focus{outline:2px solid #4d8dff;outline-offset:-1px}'
  ...
  +   'border:1px solid #4d8dff;background:#4d8dff;color:#06122b;padding:0 14px}'
  + '.edrp-btn.ghost{background:none;color:#8a93a2;border-color:#262c36}'
  ...
  + '.edrp-meta{margin-top:14px;border-top:1px solid #262c36;padding-top:10px}'
  + '.edrp-meta summary{font-size:11.5px;color:#78818f;cursor:pointer}'
  + '.edrp-meta dl{margin:8px 0 0;font:400 11px/1.6 ui-monospace,SFMono-Regular,Menlo,monospace;color:#8a93a2;'
  +   'display:grid;grid-template-columns:auto 1fr;gap:2px 10px;word-break:break-word}'
  + '.edrp-meta dt{color:#5b6472}.edrp-meta dd{margin:0}'
  + '.edrp-foot{margin-top:12px;font-size:11px;color:#5b6472;line-height:1.55}'
  + '.edrp-launch{position:fixed;right:14px;bottom:calc(14px + env(safe-area-inset-bottom));z-index:2147482000;'
  +   'background:#13161c;color:#8a93a2;border:1px solid #262c36;border-radius:999px;padding:9px 14px;'
  +   'font:600 12px/1 Inter,system-ui,sans-serif;cursor:pointer;box-shadow:0 6px 18px rgba(0,0,0,.35)}'
  + '.edrp-launch:hover{color:#e7eaf0;border-color:#4d8dff}'
  ...
  function build() {
    ...
    back.innerHTML =
      ...
      + '<label for="edrpSteps">Anything that would help us reproduce it <span style="text-transform:none;letter-spacing:0;color:#5b6472">(optional)</span></label>'
      + '<textarea id="edrpSteps" rows="2" placeholder="Optional."></textarea>'
      + '<div id="edrpContactWrap" hidden><label for="edrpContact">Your email, if you would like a reply <span style="text-transform:none;letter-spacing:0;color:#5b6472">(optional)</span></label>'
