...
(function (root, factory) {
  ...
  function scoredReliability(r, cfg, coverage) {
    ...
    return {
      ...
      lines: lines,
      /* the enrichment's DATA COVERAGE view and potential reliability, when
         the scorer was handed an evidence package (lib/game_evidence.js) */
      data_coverage: r.data_coverage || null,
      potential: r.potential && num(r.potential.score) != null ? r.potential.score : null,
