-- MODEL COLLECTIVE, UPGRADE 4: accept the shapes real model clients emit.
-- Run once in the Supabase SQL editor. Safe to run twice. Optional: existing
-- creators who already send home_team and away_team are unaffected.
