-- MODEL COLLECTIVE, UPGRADE 2: NCAA football (CFB)
-- Adds the CFB sport, the 2026 season window, and all 136 FBS programs with
-- aliases. Run once in the Supabase SQL editor. Safe to re-run.
-- Load the CFB slate afterwards with cfb-load-schedule.sql or Admin, Games.
