-- MODEL COLLECTIVE, UPGRADE 7: odds math.
-- Run after upgrade 6. Adds moneyline capture, best price per line,
-- de-vigged consensus with Pinnacle held separately. Safe to run twice.
