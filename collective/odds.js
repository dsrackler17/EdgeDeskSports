...
(function (global) {
  ...
  var CSS = [
    ...
    '.mco-tag{font-size:9.5px;letter-spacing:.14em;color:var(--faint,#5f6488);font-weight:700}',
    '.mco-mk{white-space:nowrap}',
    '.mco-mk b{font-variant-numeric:tabular-nums}',
    '.mco-dim{color:var(--dim,#9095b8)}',
    '.mco-spacer{flex:1}',
    '.mco-chip{font-size:10px;padding:2px 6px;border-radius:999px;border:1px solid var(--border,#222852);white-space:nowrap}',
    '.mco-fresh{color:var(--dim,#9095b8)}',
    '.mco-stale{color:var(--warn,#d99a2b);border-color:rgba(217,154,43,.45)}',
    '.mco-none{color:var(--faint,#5f6488)}',
    '.mco-live{color:var(--pos,#2fb47c);border-color:rgba(47,180,124,.5);font-weight:700;letter-spacing:.08em}',
    '.mco-closed{color:var(--faint,#5f6488)}',
    '.mco-empty{color:var(--dim,#9095b8);font-size:12.5px;padding:8px 0}',
    '.mco-card{border:1px solid var(--border,#222852);border-radius:10px;padding:12px;background:var(--surface,#11132f)}',
    '.mco-hd{display:flex;align-items:center;gap:8px;flex-wrap:wrap;margin-bottom:8px}',
    '.mco-gm{font-weight:600}',
    '.mco-cons,.mco-sharp{display:flex;align-items:center;gap:10px;flex-wrap:wrap;font-size:12.5px;padding:6px 0;border-top:1px solid var(--border,#222852)}',
    '.mco-note{color:var(--faint,#5f6488);font-size:11px;flex-basis:100%}',
    '.mco-mkt{border-top:1px solid var(--border,#222852);padding-top:8px;margin-top:8px}',
    '.mco-mkt-t{font-size:10px;letter-spacing:.12em;text-transform:uppercase;color:var(--dim,#9095b8);margin-bottom:4px}',
    ...
    '.mco-tbl th{font-size:10px;letter-spacing:.1em;text-transform:uppercase;color:var(--dim,#9095b8)}',
    ...
    '.mco-bk{font-size:11px;border:1px solid var(--border,#222852);border-radius:6px;padding:1px 5px;font-variant-numeric:tabular-nums;white-space:nowrap}',
    '.mco-bk i{font-style:normal;color:var(--faint,#5f6488);margin-right:5px}',
    '.mco-best{border-color:rgba(47,180,124,.6);color:var(--pos,#2fb47c)}',
    '.mco-sharpbk i{color:var(--gold,#e3b84d)}',
    '.mco-alt{font-size:10.5px;color:var(--faint,#5f6488);align-self:center}',
    '.mco-oc{display:flex;gap:16px;align-items:center;flex-wrap:wrap;border-top:1px solid var(--border,#222852);margin-top:8px;padding-top:8px;font-size:12.5px}',
    '.mco-oc span{display:flex;flex-direction:column;font-variant-numeric:tabular-nums}',
    '.mco-oc i{font-style:normal;font-size:9.5px;letter-spacing:.12em;text-transform:uppercase;color:var(--faint,#5f6488)}',
    '.mco-edge{font-variant-numeric:tabular-nums}',
    '.mco-foot{margin-top:10px;font-size:10.5px;color:var(--faint,#5f6488)}',
    '.mco-move td{border-top:1px solid var(--border,#222852)}'
  ].join('');
